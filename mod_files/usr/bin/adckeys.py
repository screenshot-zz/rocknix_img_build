...
input_device = '/dev/input/by-path/platform-rocknix-singleadc-joypad-event-joystick'  # Change this to your actual device

# Specify the keys you want to simulate
key1_code = 0x13a  # BTN_SELECT code, replace with your desired code
key2_code = 0x13b  # BTN_START code, replace with your desired code
